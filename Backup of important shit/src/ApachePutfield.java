...
public class ApachePutfield {
	...
	private URL url;
	public HttpClientContext CLIENT_CONTEXT;
	...
	//CONSTRUCTOR 
	public ApachePutfield ( JSONObject outbound, String apiend, String username, String pass ) throws UnsupportedEncodingException { 
    	...
    	System.out.println("INITIALIZING ApachePutfield..." + apiend);
    	try
    	{
		initialize();
    	} catch (Exception e) {
	...
	//authentication() used recursively in above method ^
	...
	//put() is executed independently, requires instance.CLIENT_CONTEXT as param
	public int put(HttpClientContext hccContext) throws IOException {
	     // Body:
