...
public class LocationParse extends Auth {
	...
	public String getAssignedSchool(long DISPID) throws Exception {
		...
		LocationParse test = new LocationParse();
		...
		JSONObject obj1 = asset.getJSONObject("asset");
		System.out.println("FINISHED LOCATION  -- " + asset.toString() + "\n" + obj1.toString());
		long PLID = (Long) obj1.get("location_id");
	...
	public String getAssetLocation(long DISPID) throws Exception {
		//Auth auth = new Auth();
		JSONObject object1;
